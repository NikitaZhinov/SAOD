...
template <typename TArr, typename TElem> long long BinarySearch1(const TArr &arr, size_t len, TElem x) {
...
template <typename TArr, typename TElem> long long BinarySearch2(const TArr &arr, size_t len, TElem x) {
